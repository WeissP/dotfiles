...
# tmux send 'aria2c --input-file=~/.config/aria2/downloadsURL.txt --conf-path=~/.config/aria2/aria2.conf' ENTER;      
tmux new-window -n xkeysnail
tmux send 'sudo xkeysnail ~/.config/xkeysnail/config.py --watch' ENTER;
